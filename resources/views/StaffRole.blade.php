...
$field=$_GET['field'];
     ...
     $qry=DB::table('staff_role') ->where('is_deleted',0)->where(function($query){
    
        $query->Orwhere('staff_role_name','like','%'.@$_GET['search'].'%');
...
$qry=DB::table('staff_role') ->where('is_deleted',0)->orderBy('id','desc')->paginate($limit); 
                        ...
                        <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-center">
                                <h1 class="text-white mb-0">
                                    <span class="font-w300">Staff Role</span>
                                     
                                </h1>
                            </div>
                            <div class="col-md py-3 d-md-flex align-items-md-center justify-content-md-end text-center">
                                <a href="{{url('add-staff-role')}}" class="btn btn-alt-primary mr-1">
                                    <i class="fa fa-plus mr-1"></i>Add Staff Role
                        ...
                        <!-- END Breadcrumb -->
                                ...
                                <div class="block block-rounded block-bordered block-mode-loading-refresh">
                                    <div class="block-header border-bottom">
                                        <h3 class="block-title">Staff Role</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <a type="button" href="{{url('edit-staff-role')}}?id={{$q->id}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit">
...
$(function(){
  ...
  confirmButtonText: 'Ok'
            ...
            $('#showdata').on('click','.btnDelete',function(){
                    ...
                    var c=confirm("Are you sure want to delete this Staff Role");
                    if(c){
                        window.location.href="{{url('delete-staff-role')}}?id="+id;
                    }
                            })  
           })
</script>
