...
<head>
    ...
    <title>Reset Password < Smoking Joe    </title>

<link rel="icon" 
      type="image/png" 
      href="{{asset('public/img/fav.png')}}">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('public/dashboard_assets/plugins/fontawesome-free/css/all.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{asset('public/dashboard_assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- Theme style -->
