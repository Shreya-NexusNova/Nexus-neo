          ...
          <!-- Main Container -->
            <main id="main-container">
                        ...
                        <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-center">
                                <h1 class="text-white mb-0">
                                    <span class="font-w300">Add {{$issue_qry->type_name}} Issue </span>
                ...
                <div class="bg-white">
                    <div class="content content-full">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt bg-light px-4 push">
                              ...
                              <li class="breadcrumb-item">
                                    <a href="{{url('/issue-type-detail')}}/{{$id}}">{{$issue_qry->type_name}} Issue</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Add {{$issue_qry->type_name}} Issue </li>
                            </ol>
                        </nav>
                        <!-- END Breadcrumb -->
                    ...
                    <!-- New Post -->
                    <form action="{{url('insert-issue-type-detail')}}" class="js-validation" method="POST" enctype="multipart/form-data"  >
                        @csrf
                        <input type="hidden" name="issue_type_id" value="{{$id}}">

                                             <!-- People -->
                                <div class="block block-rounded block-bordered block-mode-loading-refresh">
                                    <div class="block-header border-bottom">
                                        <h3 class="block-title">Add {{$issue_qry->type_name}} Issue</h3>
							...
							<div class="col-sm-12 m-auto" >
                                        ...
                                        <div class="  row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                            	 <input type="text" class="form-control" id="type_detail_name"  value="{{old('type_detail_name')}}" name="type_detail_name" placeholder="Name"  >
                                            </div>
                            ...
                            <div class="block-content bg-body-light">
                                <div class="row justify-content-center push">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                            ...
                                            <a href="{{url('issue-type-detail')}}/{{$id}}" type="reset" class="btn btn-alt-danger">
