...
<?php
$qry=DB::Table('location')->where('id',$_GET['id'])->first();
 ?>
          ...
          <!-- Main Container -->
            <main id="main-container">
                        ...
                        <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-center">
                                <h1 class="text-white mb-0">
                                    <span class="font-w300">Edit Location</span>
                ...
                <div class="bg-white">
                    ...
                    <!-- New Post -->
                    <form action="{{url('update-location')}}" class="js-validation" method="POST" enctype="multipart/form-data"  >
                        @csrf
							...
							<div class="col-sm-12 m-auto" >
										<div class="  row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                            	 <input type="text" class="form-control" id="location_name"  value="{{$qry->location_name}}" name="location_name" placeholder="Name"  >
                                            </div>
                            ...
                            <div class="block-content bg-body-light">
                                <div class="row justify-content-center push">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                            ...
                                            <a href="{{url('location')}}" type="reset" class="btn btn-alt-danger">
