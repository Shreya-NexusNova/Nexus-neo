          ...
          <!-- Main Container -->
            <main id="main-container">
                        ...
                        <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-center">
                                <h1 class="text-white mb-0">
                                    <span class="font-w300">Add Location</span>
                ...
                <div class="bg-white">
                    ...
                    <!-- New Post -->
                    <form action="{{url('insert-location')}}" class="js-validation" method="POST" enctype="multipart/form-data"  >
                        @csrf
                                ...
                                <div class="block block-rounded block-bordered block-mode-loading-refresh">
                                    <div class="block-header border-bottom">
                                        <h3 class="block-title">Add Location</h3>
							...
							<div class="col-sm-12 m-auto" >
										<div class="  row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                            	 <input type="text" class="form-control" id="location_name"  value="{{old('location_name')}}" name="location_name" placeholder="Name"  >
                                            </div>
