...
<?php
$qry=DB::Table('issue_type')->where('id',$_GET['id'])->first();
 ?>
          ...
          <!-- Main Container -->
            <main id="main-container">
                        ...
                        <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-center">
                                <h1 class="text-white mb-0">
                                    <span class="font-w300">Edit Issue Type</span>
                ...
                <div class="bg-white">
                    <div class="content content-full">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt bg-light px-4 push">
                              ...
                              <li class="breadcrumb-item">
                                    <a href="{{url('/issue-type')}}">Issue Type</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Edit Issue Type</li>
                            </ol>
                        </nav>
                        <!-- END Breadcrumb -->
                    ...
                    <!-- New Post -->
                    <form action="{{url('update-issue-type')}}" class="js-validation" method="POST" enctype="multipart/form-data"  >
                        @csrf
                        <input type="hidden" name="id" value="{{$_GET['id']}}">
                                ...
                                <div class="block block-rounded block-bordered block-mode-loading-refresh">
                                    <div class="block-header border-bottom">
                                        <h3 class="block-title">Edit Issue Type</h3>
							...
							<div class="col-sm-12 m-auto" >
										<div class="  row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                            	 <input type="text" class="form-control" id="type_name"  value="{{$qry->type_name}}" name="type_name" placeholder="Name"  >
                                            </div>
