          ...
          <!-- Main Container -->
            <main id="main-container">
                        ...
                        <div class="row pt-3">
                            <div class="col-md py-3 d-md-flex align-items-md-center text-center">
                                <h1 class="text-white mb-0">
                                    <span class="font-w300">Add User</span>
                ...
                <div class="bg-white">
                    ...
                    <!-- New Post -->
                    <form action="{{url('insert-users')}}" class="js-validation" method="POST" enctype="multipart/form-data"  >
                        @csrf
							...
							<div class="col-sm-12 m-auto" >
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" for="example-hf-email">Password</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" for="example-hf-email">Confirm Password</label>
                                            <div class="col-sm-6">
                            ...
                            <div class="block-content bg-body-light">
                                <div class="row justify-content-center push">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                            ...
                                            <a href="{{url('users')}}" type="reset" class="btn btn-alt-danger">
